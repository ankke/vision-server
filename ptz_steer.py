...
IP = "192.168.0.53"  # Camera IP address
PORT = 80  # Port
USER = "admin"  # Username
PASS = "AGHspace"  # Password
...
def perform_move(ptz, timeout, request):
    global active
...
def setup_move():
    ...
    print("mycam " + str(mycam.__dict__))
